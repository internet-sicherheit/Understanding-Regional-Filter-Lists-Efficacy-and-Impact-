...
def optimize_prefs(fo: Options) -> None:
    ...
    * https://github.com/pyllyukko/user.js/blob/master/user.js
    ...
    fo.set_preference("browser.safebrowsing.provider.mozilla.justdomain_lists", "")  # TP
    fo.set_preference("browser.safebrowsing.provider.google.justdomain_lists", "")  # TP
    fo.set_preference("browser.safebrowsing.provider.google4.justdomain_lists", "")  # TP
