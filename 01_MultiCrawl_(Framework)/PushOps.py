...
def stream2BQ(p_siteData):
    try:
            ...
            if cookies is not None:
                for item in cookies:
                    ...
                    try:
                        ...
                        execBQRows('filterlists.measurement.cookies', item, 25)
            ...
            if localStorage is not None:
                for item in localStorage:
                    ...
                    try:
                        ...
                        execBQRows(
                            'filterlists.measurement.localstorage', item, 25)
                    except Exception as e:
                        pushError(siteData.site_id,
        ...
        try:
            execBQRows('filterlists.measurement.requests', all_requests, 45)
            all_pushed_req = True
        except:
            all_pushed_req = False
            ...
            for visit in siteData.visitData:
                ...
                if requests is not None:
                    for item in requests:
                        ...
                        try:
                            execBQRows(
                                'filterlists.measurement.requests', item, 15)
                        except:
        ...
        try:
            execBQRows('filterlists.measurement.responses', all_response, 45)
            all_pushed_res = True
        except:
            all_pushed_res = False
            ...
            for visit in siteData.visitData:
                ...
                if responses is not None:
                    for item in responses:
                        ...
                        try:
                            execBQRows(
                                'filterlists.measurement.responses', item, 15)
                        except:
        ...
        if all_callstacks:
            ...
            try:
                execBQRows('filterlists.measurement.callstacks', all_callstacks, 45)
                ...
                for visit in siteData.visitData:
                    ...
                    if callstacks is not None:
                        for item in callstacks:
                            ...
                            try:
                                execBQRows(
                                    'filterlists.measurement.callstacks', item, 15)
                            except:
                                pushError(siteData.site_id,
        ...
        if all_dns_responses:
            ...
            try:
                execBQRows('filterlists.measurement.dns_responses', all_dns_responses, 45)
                ...
                for visit in siteData.visitData:
                    ...
                    if dns_responses is not None:
                        for item in dns_responses:
                            ...
                            try:
                                execBQRows(
                                    'filterlists.measurement.dns_responses', item, 15)
                            except:
                                pushError(siteData.site_id,
        ...
        if all_incomplete_visit: 
            ...
            try:
                execBQRows('filterlists.measurement.incomplete_visits', all_incomplete_visit, 45)
                ...
                for visit in siteData.visitData:
                    ...
                    if incomplete_visit is not None:
                        for item in incomplete_visit:
                            ...
                            try:
                                execBQRows(
                                    'filterlists.measurement.incomplete_visits', item, 15)
                            except:
                                pushError(siteData.site_id,
        ...
        if all_http_redirects:
            ...
            try:
                execBQRows('filterlists.measurement.http_redirects', all_http_redirects, 45)
                ...
                for visit in siteData.visitData:
                    ...
                    if http_redirects is not None:
                        for item in http_redirects:
                            ...
                            try:
                                execBQRows(
                                    'filterlists.measurement.http_redirects', item, 15)
                            except:
                                pushError(siteData.site_id,
        ...
        if all_navigations:
            ...
            try:
                execBQRows('filterlists.measurement.navigations', all_navigations, 45)
                ...
                for visit in siteData.visitData:
                    ...
                    if navigations is not None:
                        for item in navigations:
                            ...
                            try:
                                execBQRows(
                                    'filterlists.measurement.navigations', item, 15)
                            except:
                                pushError(siteData.site_id,
        ...
        for visit in siteData.visitData:  
            ...
            if requests is not None:  
                for item in requests:
                    ...
                    push_request = push_request + len(item)
                    try:
                        execBQRows('filterlists.measurement.requests', item) 
                    except:
            ...
            if responses is not None:
                ...
                for item in responses:
                    ...
                    try:
                        execBQRows('filterlists.measurement.responses', item) 
                    except:
                        print(item)
    ...
    if siteData.crawlData != None:
        ...
        for item in allReq:
            print('pushing chunked req: ', str(len(item)))
            try:
                execBQRows('filterlists.measurement.http_request',
                           item)
                push_request=1
            except:
        ...
        for item in allRes:
            print('pushing chunked res: ', str(len(item)))
            try:
                execBQRows('filterlists.measurement.http_response',
                       item)
                push_response=1
            except:
                print(item)
        ...
        if siteData.cookies:
            try:
                ...
                execBQRows('filterlists.measurement.cookies', siteData.cookies)
                push_cookie=1
            except Exception as e:
        ...
        if siteData.localStorage:
            try:
                ...
                execBQRows('filterlists.measurement.localstorage',
